...
//
//
//VkResult CreateDebugUtilsMessengerEXT2(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
//		}
//		
//		vkDestroyCommandPool(device, localCommandPool, nullptr);
...
//		}
//
//		checkExtensions(extensions.data(), numExtensions);
//	}
//
//	void checkExtensions(const char** requiredExtensions,uint32_t numExtensions)
//	{
...
//		for (int i = 0; i < numExtensions; i++)
//		{
//			bool currentExtensionFound = false;
//			for (const auto& extension : extensions)
//			{
//				if (!strcmp(requiredExtensions[i],extension.extensionName))
//				{
//					currentExtensionFound = true;
//					break;
//				}
//			}
//			if (!currentExtensionFound)
//			{
...
//		{
//			std::cout << "All required extensions are present\n";
//		}
//		else
//		{
//			std::cout << "Not all required extensions are present\n";
//		}
//
//
//	}
...
//		if (vkCreateCommandPool(device, &localPoolInfo, nullptr, &localCommandPool) != VK_SUCCESS)
//		{
...
//		allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
//		allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
//		allocInfo.commandPool = localCommandPool;
...
//
//		vkFreeCommandBuffers(device, localCommandPool, 1, &commandBuffer);
//	}
//
